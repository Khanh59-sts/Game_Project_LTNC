...
// Quản lý đầu vào của Gamer
glm::vec2 InputHandler::GetCharacterMoveVelocity() // Lấy vận tốc từ các phím
{
...
glm::vec2 InputHandler::GetGodMoveVelocity() // God Mod
{
    glm::vec2 input_velocity = {0, 0};
    if (isForwardPressed()) 
    { input_velocity.x = 1; } 
...
bool InputHandler::isForwardPressed()  // Kiểm tra nút di chuyển WASD
{
